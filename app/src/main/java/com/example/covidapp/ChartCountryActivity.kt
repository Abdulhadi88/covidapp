...
import com.example.covidapp.network.RetrofitBuilder
...
class ChartCountryActivity : AppCompatActivity() {
    companion object{
        const val  EXTRA_COUNTRY = "EXSTRA_COUNTRY"
        lateinit var simpanDataNegara : String
        lateinit var simpanDataFlag : String
    }

    private val sharedPrefFile = "kotlinsharedprefrence"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPrefernces = this.getSharedPreferences(sharedPrefFile, Context.MODE_PRIVATE)
        ...
        data?.let {
            ...
            val simpanNegara = sharedPrefernces.getString(data.Country , data.Country)
            val simpanFlag = sharedPrefernces.getString(data.CountryCode , data.CountryCode)
